...
- ✅ Phase 6 – Mutationstests: eigener Runner (`tool/mutation_test.py`, 10 Mutationen) + 2 vorab geschlossene Testlücken, **Mutation Score 10/10 (100 %)** über echten CI-Lauf verifiziert ([`34959301982`](https://github.com/BonorumSoft/Werkzeugkiste/actions/runs/34959301982), siehe `reports/phase6_mutation.md`)
- ✅ Phase 7 – Dokumentation: alle 8 ADRs aus Abschnitt 47 formal dokumentiert (`docs/adr/`), Architekturdoku erweitert (`docs/ARCHITECTURE.md`). Alle 8 ADRs sind inzwischen final **entschieden** (Tjorben, September 2026); ADR-03 (Invite-System) mit Code-Konsequenz umgesetzt (`lib/domain/invite.dart`, `lib/domain/invite_service.dart`), über echten CI-Lauf grün verifiziert ([`34964560149`](https://github.com/BonorumSoft/Werkzeugkiste/actions/runs/34964560149))
